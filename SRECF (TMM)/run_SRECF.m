function results = run_SRECF(seq,p1,p2,p3,p4)
...
%   Learning parameters
params.learning_rate       =0.025;        % learning rate  0.025
params.output_sigma_factor = 0.066;		% standard deviation of the desired correlation output (proportional to target)0.064
...
params.target_region=2;
params.pool_layer=10;
