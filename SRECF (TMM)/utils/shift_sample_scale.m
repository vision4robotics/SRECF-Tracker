function out = shift_sample_scale(im, pos, base_target_sz,xs,recovered_scale,scaleFactors,scale_window,scale_model_sz,features,global_feat_params)
        ...
        elseif  shift_pos>0
            ...
            for i=1:shift_pos
                ...
                temp_total=get_features(im_patch_resized,features,global_feat_params);
                temp = temp_total(:,:,:);
